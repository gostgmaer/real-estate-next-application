    ...
    <header className="bg-white w-full">
      ...
      >
        ...
        <div className=" lg:flex lg:gap-x-10 lg:flex-1 lg:justify-center">
          {" "}
          <form className="flex bg-slate-100 items-center p-3 rounded-lg w-full">
            <input
              type="text"
              placeholder="Search..."
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-10 lg:flex-1 lg:justify-end">
          ...
          {/* <Input label={undefined} type={undefined} additionalAttrs={undefined} classes={undefined} icon={undefined} id={undefined}/> */}
